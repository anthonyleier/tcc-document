...
\begin{itemize}
    \item \textbf{K-Nearest Neighbors (KNN):} o KNN é uma abordagem de um algortmo que busca realizar a classificação com base na comparação de um dado com dados semelhantes a ele. É considerado uma abordagem \emph{lazy} ou seja preguiçosa, pois não apresenta um modelo inteligente em si, apenas armazena os dados e realiza comparações.
