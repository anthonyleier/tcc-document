...
Aplicada para detectar sangue
será empirica onde serao realizados diversos testes com diferentes modelos que serao comparados
descrever as metricas utilizadas
iniciou com uma pesquisa exploratoria para delimitar o escopo e compreender melhor os aspectos que estao sendo aplicados para esse dominio de problema

essa pesquisa exploratoria compreeendendeu um mapeamento siste da lit onde se identifiocu que

A epsquisa bibliografico compreendeu o mapeamento e fundamentacao teorica
PESQUISA EXPERIMENTAL

Pesquisa bibliográfica
pesquisa experimental -> classificacao
